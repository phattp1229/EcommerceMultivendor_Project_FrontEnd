...
import { loginAdmin, sendLoginSignupOtp, signin } from '../../../Redux Toolkit/Customer/AuthSlice';
...
const AdminLoginForm = () => {
 ...
 validationSchema: validationSchema,
        onSubmit: (values: any) => {
            ...
            dispatch(loginAdmin({ email: values.email,username: values.username,password: values.password, otp ,navigate }))
    ...
    return (
        <div>
            <h1 className='text-center font-bold text-xl text-primary-color pb-8'>Login Admin</h1>
