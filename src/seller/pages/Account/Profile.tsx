...
import { modalStyle } from "./profileModalStyle";
    ...
    <div className="lg:p-20 space-y-20">
      ...
      <div className="mt-10 lg:w-[70%]">
        ...
        <div className=" ">
          ...
          <ProfileFildCard
            keys={"TaxCode"}
            value={sellers.profile?.taxCode || "not provided"}
          />
          <Divider />
          <ProfileFildCard
            keys={"Account Status"}
      ...
      <div className="mt-10 lg:w-[70%]">
        ...
        <div className="space-y-5">
          <div className="">
            <ProfileFildCard
              keys={"Adress"}
              value={sellers.profile?.pickupAddress?.street}
            />
            <Divider />
            <ProfileFildCard
              keys={"City"}
      ...
      <div className="mt-10 lg:w-[70%]">
        ...
        <div className="space-y-5">
          <div className="">
            ...
            <ProfileFildCard
              keys={"Bank Name"}
              value={sellers.profile?.bankDetails?.bankName}
            />
          </div>
        </div>
      </div>
      ...
      >
        <Box sx={modalStyle}>{renderSelectedForm()}</Box>
