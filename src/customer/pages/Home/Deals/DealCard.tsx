...
const DealCard = ({deal}:{deal:Deal}) => {
  ...
  return (
    <div onClick={()=>navigate(`/products/${deal.category.categoryId}`)} className='w-full  h-[12rem] cursor-pointer '>
        ...
        <div className='w-full h-[12rem] border-4 border-black bg-black text-white p-2 text-center'>
