// src/customer/pages/Account/KOC/KocDashboard.tsx
...
import {
  ...
  Snackbar, Stack, TextField, Typography, Pagination, Select, MenuItem, FormControl, InputLabel
} from "@mui/material";
...
const revenue: RevenuePoint[] = [
  { month: "Jan", value: 120 }, { month: "Feb", value: 180 },
  { month: "Mar", value: 90 },  { month: "Apr", value: 240 },
  { month: "May", value: 300 }, { month: "Jun", value: 260 },
];
const orders: RevenuePoint[] = [
  { month: "Jan", value: 12 }, { month: "Feb", value: 16 },
  { month: "Mar", value: 8 },  { month: "Apr", value: 22 },
  { month: "May", value: 28 }, { month: "Jun", value: 24 },
];
const clicks: RevenuePoint[] = [
  { month: "Jan", value: 140 }, { month: "Feb", value: 210 },
  { month: "Mar", value: 120 }, { month: "Apr", value: 280 },
  { month: "May", value: 340 }, { month: "Jun", value: 300 },
];
    ...
    <Stack spacing={3}>
      ...
      <Card variant="outlined" sx={{ borderRadius: 2 }}>
        ...
        <CardContent>
          ...
          {/* Pagination controls — đặt ngoài map, chỉ hiển thị 1 lần */}
      ...
      <Dialog open={openRegister} onClose={() => setOpenRegister(false)} fullWidth maxWidth="sm">
        ...
        <DialogContent>
          <Stack spacing={2} mt={1}>
            <TextField label="Campaign Code" size="small" placeholder="e.g. SUMMER24" />
            <TextField label="Note (optional)" size="small" multiline minRows={2} />
          </Stack>
        </DialogContent>
        <DialogActions>
